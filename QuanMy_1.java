...
public class QuanMy_1 extends Bosses implements MouseListener{
    // the name of the boss
	String Name = "Thuy Tinh";

	// the source of the image to navigate
	String ImageSource = "Assets/BossCards/Phase_5/Quan_My_1.png";
	...
	public QuanMy_1(int Width, int Height, int scale, BossLabel thisParent) {
		width = Width * scale;
        height = Height * scale;
		bound = width/20;
		parent = thisParent;
