...
public class Warship_2 extends Bosses implements MouseListener{
	...
	public Warship_2(int Width, int Height, int scale, BossLabel thisParent) {
		width = Width * scale;
        height = Height * scale;
		bound = width/20;
		parent = thisParent;
	...
	public void mouseClicked(MouseEvent e) {
		if (choosable){
			...
			parent.parent.playerLabel.phasePlayerState(parent.parent.turn, 2);
		}
		else {
